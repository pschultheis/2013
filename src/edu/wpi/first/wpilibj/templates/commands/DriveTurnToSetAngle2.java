 ...
 * @author Developer
 */
public class DriveTurnToSetAngle2 extends CommandBase {
    ...
    protected void initialize() {
        ...
        DriverStationLCD.getInstance().println(DriverStationLCD.Line.kUser1, 1, this.angle + "");
